...
public class opciones {
		...
		try {
			if (listaDeResultados.size() > 0) {
				...
				if (!bExists) {
					...
					FileWriter escritor = new FileWriter(archivoSalida, true); // El segundo parámetro "true" indica
																				// agregar al final
	...
	// Define el archivo de texto que sera de escritura para los resultados
	// obtenidos
